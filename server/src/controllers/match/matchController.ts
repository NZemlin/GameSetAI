...
export const getVideoMatchData: RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    console.error('Error getting video match data:', error);
    next(error);
  }
};

// Save match data for a specific video
export const saveVideoMatchData: RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    console.error('Error saving video match data:', error);
    next(error);
  }
};

// Delete match data for a specific video
export const deleteVideoMatchData: RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    if (!matchData[videoId]) {
      res.json({ 
        success: true,
        message: 'No match data found for this video'
      });
      return;
    }
    ...
    console.error('Error deleting video match data:', error);
    next(error);
  }
};

// Reset match data for a specific video
export const resetVideoMatchData: RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    console.error('Error resetting video match data:', error);
    next(error);
  }
}; 